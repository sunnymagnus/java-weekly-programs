...
public class Program12 {public static void main(String[] args){Shape[] shapes={new Circle(5),new Rectangle(4,6),new Triangle(3,8)};for(Shape shape:shapes){shape.area();shape.display();System.out.println("----------------");}}}
