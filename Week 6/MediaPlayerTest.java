...
class AudioFile extends MediaFile {
    AudioFile(String name,double duration,double size) {
        super(name,duration,size);
    }
    void play() {
...
class VideoFile extends MediaFile {
    VideoFile(String name,double duration,double size) {
        super(name,duration,size);
    }
    void play() {
...
class LiveStream extends MediaFile {
    LiveStream(String name,double duration,double size) {
        super(name,duration,size);
    }
    void play() {
...
public class MediaPlayerTest {
    public static void main(String[] args) {
        MediaFile m=new AudioFile("song.mp3",3.5,5);
        m.play();
        m.pause();
        m.stop();
        System.out.println("----------------------");
        ...
        m.stop();
        System.out.println("----------------------");
        m=new LiveStream("Live News",0,0);
        m.play();
        m.pause();
        m.stop();
    }
