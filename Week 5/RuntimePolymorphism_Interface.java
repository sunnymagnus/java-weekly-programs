...
class UPIPayment implements Payment {
    ...
    public void pay(double amount) {
        ...
        if(enteredPin==upiPin) {
            ...
            else System.out.println("UPI Payment Failed: Insufficient Balance.");
        }
...
public class RuntimePolymorphism_Interface {
